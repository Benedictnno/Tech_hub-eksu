  ...
  try {
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto; padding: 0; border: 1px solid #eee; border-radius: 10px; overflow: hidden;">
        ...
        <img src="https://vrb7y8piiyqjtoqh.public.blob.vercel-storage.com/OBJECTS.png" alt="TechHub EKSU Logo" style="width: 100vw; height: auto; background-color: #00bcd4; margin:0 auto;">
